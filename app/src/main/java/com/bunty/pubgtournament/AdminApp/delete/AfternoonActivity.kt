...
class AfternoonActivity : AppCompatActivity() {
    ...
    private fun getData() {
        reference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                deleteAdapter = DeleteMatchAdapter(deleteList, this@AfternoonActivity)
            ...
            override fun onCancelled(error: DatabaseError) {
                progressBar.isVisible = false
                Toast.makeText(this@AfternoonActivity, "$error", Toast.LENGTH_SHORT).show()
            }
